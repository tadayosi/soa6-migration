...
import org.switchyard.quickstarts.webservice.consumer2.ws.OrderProcessorWS;
...
public class WebserviceConsumer2Test {
    
    private static final String WEB_SERVICE = "http://localhost:8080/Quickstart_webservice_consumer2/OrderProcessorWS";
    private static final String QUEUE_NAME = "quickstart_webservice_consumer2_Request";
    ...
    public static void startWebService() throws Exception {
        _endpoint = Endpoint.publish(WEB_SERVICE, new OrderProcessorWS());
    }
